...
usage()
{
  ...
  echo "  --target-rid, -r <value>        Runtime identifier to be used by the build. e.g. alpine.3.18-arm64, fedora.37-x64, freebsd.13-arm64, ubuntu.19.10-x64"
