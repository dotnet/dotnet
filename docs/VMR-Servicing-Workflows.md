...
This approach would have closely matched the workflow used in 9.0 and prior releases, with adjustments required due to the VMR workflow.
Check [earlier docs](https://github.com/dotnet/dotnet/blob/07fea9bb045ef81a99b6070b94da9785d0d56c0c/docs/VMR-Servicing-Workflows.md#alternative-considered---general-servicing-branches-only) for the details of this approach.
