...
[assembly: System.Reflection.AssemblyFileVersion("10.0.926.27113")]
[assembly: System.Reflection.AssemblyInformationalVersion("10.0.9+901ca941248413c79832d2fdbd709da0c4386353")]
...
namespace System.Runtime.InteropServices
{
    ...
    {
        public static ReadOnlySpan<byte> GetRawUtf8PropertyName(Text.Json.JsonProperty property) { throw null; }
        public static ReadOnlySpan<byte> GetRawUtf8Value(Text.Json.JsonElement element) { throw null; }
    }
}
...
namespace System.Text.Json
{
    ...
    public readonly partial struct JsonElement
    {
        ...
        public static bool DeepEquals(JsonElement element1, JsonElement element2) { throw null; }
        ...
        public readonly int GetPropertyCount() { throw null; }
        ...
        public static JsonElement Parse(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default) { throw null; }
        public static JsonElement Parse(ReadOnlySpan<char> json, JsonDocumentOptions options = default) { throw null; }
        public static JsonElement Parse(string json, JsonDocumentOptions options = default) { throw null; }
    ...
    {
        [Diagnostics.CodeAnalysis.FeatureSwitchDefinition("System.Text.Json.JsonSerializer.IsReflectionEnabledByDefault")]
        ...
        public static Threading.Tasks.ValueTask<object?> DeserializeAsync(IO.Pipelines.PipeReader utf8Json, Serialization.Metadata.JsonTypeInfo jsonTypeInfo, Threading.CancellationToken cancellationToken = default) { throw null; }
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        public static Threading.Tasks.ValueTask<object?> DeserializeAsync(IO.Pipelines.PipeReader utf8Json, Type returnType, JsonSerializerOptions? options = null, Threading.CancellationToken cancellationToken = default) { throw null; }
        public static Threading.Tasks.ValueTask<object?> DeserializeAsync(IO.Pipelines.PipeReader utf8Json, Type returnType, Serialization.JsonSerializerContext context, Threading.CancellationToken cancellationToken = default) { throw null; }
        ...
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        public static Threading.Tasks.ValueTask<TValue?> DeserializeAsync<TValue>(IO.Pipelines.PipeReader utf8Json, JsonSerializerOptions? options = null, Threading.CancellationToken cancellationToken = default) { throw null; }
        public static Threading.Tasks.ValueTask<TValue?> DeserializeAsync<TValue>(IO.Pipelines.PipeReader utf8Json, Serialization.Metadata.JsonTypeInfo<TValue> jsonTypeInfo, Threading.CancellationToken cancellationToken = default) { throw null; }
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        ...
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        public static Collections.Generic.IAsyncEnumerable<TValue?> DeserializeAsyncEnumerable<TValue>(IO.Pipelines.PipeReader utf8Json, bool topLevelValues, JsonSerializerOptions? options = null, Threading.CancellationToken cancellationToken = default) { throw null; }
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        public static Collections.Generic.IAsyncEnumerable<TValue?> DeserializeAsyncEnumerable<TValue>(IO.Pipelines.PipeReader utf8Json, JsonSerializerOptions? options = null, Threading.CancellationToken cancellationToken = default) { throw null; }
        public static Collections.Generic.IAsyncEnumerable<TValue?> DeserializeAsyncEnumerable<TValue>(IO.Pipelines.PipeReader utf8Json, Serialization.Metadata.JsonTypeInfo<TValue> jsonTypeInfo, bool topLevelValues, Threading.CancellationToken cancellationToken = default) { throw null; }
        public static Collections.Generic.IAsyncEnumerable<TValue?> DeserializeAsyncEnumerable<TValue>(IO.Pipelines.PipeReader utf8Json, Serialization.Metadata.JsonTypeInfo<TValue> jsonTypeInfo, Threading.CancellationToken cancellationToken = default) { throw null; }
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        public static Collections.Generic.IAsyncEnumerable<TValue?> DeserializeAsyncEnumerable<TValue>(IO.Stream utf8Json, bool topLevelValues, JsonSerializerOptions? options = null, Threading.CancellationToken cancellationToken = default) { throw null; }
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        ...
        public static Collections.Generic.IAsyncEnumerable<TValue?> DeserializeAsyncEnumerable<TValue>(IO.Stream utf8Json, Serialization.Metadata.JsonTypeInfo<TValue> jsonTypeInfo, bool topLevelValues, Threading.CancellationToken cancellationToken = default) { throw null; }
        ...
        public static Threading.Tasks.Task SerializeAsync(IO.Pipelines.PipeWriter utf8Json, object? value, Serialization.Metadata.JsonTypeInfo jsonTypeInfo, Threading.CancellationToken cancellationToken = default) { throw null; }
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        public static Threading.Tasks.Task SerializeAsync(IO.Pipelines.PipeWriter utf8Json, object? value, Type inputType, JsonSerializerOptions? options = null, Threading.CancellationToken cancellationToken = default) { throw null; }
        public static Threading.Tasks.Task SerializeAsync(IO.Pipelines.PipeWriter utf8Json, object? value, Type inputType, Serialization.JsonSerializerContext context, Threading.CancellationToken cancellationToken = default) { throw null; }
        ...
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
        public static Threading.Tasks.Task SerializeAsync<TValue>(IO.Pipelines.PipeWriter utf8Json, TValue value, JsonSerializerOptions? options = null, Threading.CancellationToken cancellationToken = default) { throw null; }
        public static Threading.Tasks.Task SerializeAsync<TValue>(IO.Pipelines.PipeWriter utf8Json, TValue value, Serialization.Metadata.JsonTypeInfo<TValue> jsonTypeInfo, Threading.CancellationToken cancellationToken = default) { throw null; }
        [Diagnostics.CodeAnalysis.RequiresUnreferencedCode("JSON serialization and deserialization might require types that cannot be statically analyzed. Use the overload that takes a JsonTypeInfo or JsonSerializerContext, or make sure all of the required types are preserved.")]
        [Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
    ...
    public sealed partial class JsonSerializerOptions
    {
        ...
        public static JsonSerializerOptions Strict { get { throw null; } }
        ...
        public static JsonSerializerOptions Web { get { throw null; } }
        ...
        public void AddContext<TContext>() where TContext : Serialization.JsonSerializerContext, new() { }
...
namespace System.Text.Json.Nodes
{
    public sealed partial class JsonArray : JsonNode, Collections.Generic.IList<JsonNode?>, Collections.Generic.ICollection<JsonNode?>, Collections.Generic.IEnumerable<JsonNode?>, Collections.IEnumerable
    {
        ...
        public JsonArray(params scoped ReadOnlySpan<JsonNode?> items) { }
        public JsonArray(params JsonNode?[] items) { }
        public JsonArray(JsonNodeOptions options, params scoped ReadOnlySpan<JsonNode?> items) { }
        ...
        public int RemoveAll(Func<JsonNode?, bool> match) { throw null; }
    ...
    public sealed partial class JsonObject : JsonNode, Collections.Generic.IDictionary<string, JsonNode?>, Collections.Generic.ICollection<Collections.Generic.KeyValuePair<string, JsonNode?>>, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, JsonNode?>>, Collections.IEnumerable, Collections.Generic.IList<Collections.Generic.KeyValuePair<string, JsonNode?>>
    {
        ...
        Collections.Generic.KeyValuePair<string, JsonNode?> Collections.Generic.IList<Collections.Generic.KeyValuePair<string, JsonNode>>.this[int index] { get { throw null; } set { } }
        ...
        public Collections.Generic.KeyValuePair<string, JsonNode?> GetAt(int index) { throw null; }
        ...
        int Collections.Generic.IList<Collections.Generic.KeyValuePair<string, JsonNode>>.IndexOf(Collections.Generic.KeyValuePair<string, JsonNode> item) { throw null; }
        void Collections.Generic.IList<Collections.Generic.KeyValuePair<string, JsonNode>>.Insert(int index, Collections.Generic.KeyValuePair<string, JsonNode> item) { }
        void Collections.Generic.IList<Collections.Generic.KeyValuePair<string, JsonNode>>.RemoveAt(int index) { }
        Collections.IEnumerator Collections.IEnumerable.GetEnumerator() { throw null; }
        ...
        public bool TryGetPropertyValue(string propertyName, out JsonNode? jsonNode, out int index) { throw null; }
...
namespace System.Text.Json.Schema
{
    ...
    {
        public static Nodes.JsonNode GetJsonSchemaAsNode(this JsonSerializerOptions options, Type type, JsonSchemaExporterOptions? exporterOptions = null) { throw null; }
        public static Nodes.JsonNode GetJsonSchemaAsNode(this Serialization.Metadata.JsonTypeInfo typeInfo, JsonSchemaExporterOptions? exporterOptions = null) { throw null; }
    }
    ...
    public readonly partial struct JsonSchemaExporterContext
    {
        private readonly object _dummy;
        private readonly int _dummyPrimitive;
        public Serialization.Metadata.JsonTypeInfo? BaseTypeInfo { get { throw null; } }
        public ReadOnlySpan<string> Path { get { throw null; } }
        public Serialization.Metadata.JsonPropertyInfo? PropertyInfo { get { throw null; } }
        public Serialization.Metadata.JsonTypeInfo TypeInfo { get { throw null; } }
    }

    public sealed partial class JsonSchemaExporterOptions
    {
        public static JsonSchemaExporterOptions Default { get { throw null; } }
        public Func<JsonSchemaExporterContext, Nodes.JsonNode, Nodes.JsonNode>? TransformSchemaNode { get { throw null; } init { } }
...
namespace System.Text.Json.Serialization
{
    ...
    public sealed partial class JsonSourceGenerationOptionsAttribute : JsonAttribute
    {
        ...
        public JsonCommentHandling ReadCommentHandling { get { throw null; } set { } }
        public JsonKnownReferenceHandler ReferenceHandler { get { throw null; } set { } }
        public bool RespectNullableAnnotations { get { throw null; } set { } }
        public bool RespectRequiredConstructorParameters { get { throw null; } set { } }
    ...
    public partial class JsonStringEnumMemberNameAttribute : Attribute
    {
...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    public static partial class JsonMetadataServices
    {
        ...
        public static JsonTypeInfo<TCollection> CreateConcurrentQueueInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Concurrent.ConcurrentQueue<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateConcurrentStackInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Concurrent.ConcurrentStack<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateDictionaryInfo<TCollection, TKey, TValue>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.Dictionary<TKey, TValue> where TKey : notnull { throw null; }
        public static JsonTypeInfo<TCollection> CreateIAsyncEnumerableInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.IAsyncEnumerable<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateICollectionInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.ICollection<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateIDictionaryInfo<TCollection>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.IDictionary { throw null; }
        public static JsonTypeInfo<TCollection> CreateIDictionaryInfo<TCollection, TKey, TValue>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.IDictionary<TKey, TValue> where TKey : notnull { throw null; }
        public static JsonTypeInfo<TCollection> CreateIEnumerableInfo<TCollection>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.IEnumerable { throw null; }
        public static JsonTypeInfo<TCollection> CreateIEnumerableInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.IEnumerable<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateIListInfo<TCollection>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.IList { throw null; }
        public static JsonTypeInfo<TCollection> CreateIListInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.IList<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateImmutableDictionaryInfo<TCollection, TKey, TValue>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo, Func<Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<TKey, TValue>>, TCollection> createRangeFunc) where TCollection : Collections.Generic.IReadOnlyDictionary<TKey, TValue> where TKey : notnull { throw null; }
        public static JsonTypeInfo<TCollection> CreateImmutableEnumerableInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo, Func<Collections.Generic.IEnumerable<TElement>, TCollection> createRangeFunc) where TCollection : Collections.Generic.IEnumerable<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateIReadOnlyDictionaryInfo<TCollection, TKey, TValue>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.IReadOnlyDictionary<TKey, TValue> where TKey : notnull { throw null; }
        public static JsonTypeInfo<TCollection> CreateISetInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.ISet<TElement> { throw null; }
        public static JsonTypeInfo<TCollection> CreateListInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.List<TElement> { throw null; }
        ...
        public static JsonTypeInfo<TCollection> CreateQueueInfo<TCollection>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo, Action<TCollection, object?> addFunc) where TCollection : Collections.IEnumerable { throw null; }
        public static JsonTypeInfo<TCollection> CreateQueueInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.Queue<TElement> { throw null; }
        ...
        public static JsonTypeInfo<TCollection> CreateStackInfo<TCollection>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo, Action<TCollection, object?> addFunc) where TCollection : Collections.IEnumerable { throw null; }
        public static JsonTypeInfo<TCollection> CreateStackInfo<TCollection, TElement>(JsonSerializerOptions options, JsonCollectionInfoValues<TCollection> collectionInfo) where TCollection : Collections.Generic.Stack<TElement> { throw null; }
        ...
        public static JsonConverter<T?> GetNullableConverter<T>(JsonTypeInfo<T> underlyingTypeInfo) where T : struct { throw null; }
        public static JsonConverter<T> GetUnsupportedTypeConverter<T>() { throw null; }
    }

    public sealed partial class JsonObjectInfoValues<T>
    {
        public Func<System.Reflection.ICustomAttributeProvider>? ConstructorAttributeProviderFactory { get { throw null; } init { } }
    ...
    public abstract partial class JsonParameterInfo
    {
        ...
        public Type DeclaringType { get { throw null; } }
        ...
        public string Name { get { throw null; } }
        public Type ParameterType { get { throw null; } }
    ...
    public abstract partial class JsonPropertyInfo
    {
        ...
        public JsonParameterInfo? AssociatedParameter { get { throw null; } }
    ...
    {
        public Func<System.Reflection.ICustomAttributeProvider>? AttributeProviderFactory { get { throw null; } init { } }
    ...
    public abstract partial class JsonTypeInfo
    {
        ...
        public bool IsReadOnly { get { throw null; } }
        public Type? KeyType { get { throw null; } }
    ...
    {
        public static IJsonTypeInfoResolver Combine(params scoped ReadOnlySpan<IJsonTypeInfoResolver?> resolvers) { throw null; }
