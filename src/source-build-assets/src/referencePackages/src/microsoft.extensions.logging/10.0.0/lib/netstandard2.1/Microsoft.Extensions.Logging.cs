...
namespace Microsoft.Extensions.Logging
{
    ...
    public static partial class FilterLoggingBuilderExtensions
    {
        ...
        public static ILoggingBuilder AddFilter<T>(this ILoggingBuilder builder, System.Func<LogLevel, bool> levelFilter) where T : ILoggerProvider { throw null; }
        public static ILoggingBuilder AddFilter<T>(this ILoggingBuilder builder, System.Func<string?, LogLevel, bool> categoryLevelFilter) where T : ILoggerProvider { throw null; }
        public static ILoggingBuilder AddFilter<T>(this ILoggingBuilder builder, string? category, LogLevel level) where T : ILoggerProvider { throw null; }
        public static ILoggingBuilder AddFilter<T>(this ILoggingBuilder builder, string? category, System.Func<LogLevel, bool> levelFilter) where T : ILoggerProvider { throw null; }
        public static LoggerFilterOptions AddFilter<T>(this LoggerFilterOptions builder, System.Func<LogLevel, bool> levelFilter) where T : ILoggerProvider { throw null; }
        public static LoggerFilterOptions AddFilter<T>(this LoggerFilterOptions builder, System.Func<string?, LogLevel, bool> categoryLevelFilter) where T : ILoggerProvider { throw null; }
