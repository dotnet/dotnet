...
namespace Microsoft.Build.Utilities
{
    ...
    public sealed partial class TaskItem : Framework.ITaskItem2, Framework.ITaskItem
    {
        ...
        public TaskItem(string itemSpec, bool treatAsFilePath) { }
    ...
    public partial class TaskLoggingHelper
    {
        ...
        public void LogErrorWithCodeAndExceptionFromResources(System.Exception exception, bool showStackTrace, bool showDetail, string messageResourceName, params object[] messageArgs) { }
        public void LogErrorWithCodeAndExceptionFromResources(System.Exception exception, bool showStackTrace, bool showDetail, string subcategory, string file, int lineNumber, int columnNumber, int endLineNumber, int endColumnNumber, string messageResourceName, params object[] messageArgs) { }
        public void LogErrorWithCodeAndExceptionFromResources(System.Exception exception, bool showStackTrace, bool showDetail, string file, string messageResourceName, params object[] messageArgs) { }
    ...
    public abstract partial class ToolTask : Task, Framework.IIncrementalTask, Framework.ICancelableTask, Framework.ITask, Framework.IMultiThreadableTask
    {
        protected ToolTask() { }
        ...
        protected bool ExitCodeOverriddenToIndicateErrors { get { throw null; } }
        ...
        public virtual Framework.TaskEnvironment TaskEnvironment { get { throw null; } set { } }
        ...
        protected void DeleteTempFile(Framework.AbsolutePath filePath) { }
