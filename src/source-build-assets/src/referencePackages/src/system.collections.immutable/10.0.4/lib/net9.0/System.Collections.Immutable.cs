...
[assembly: System.Reflection.AssemblyFileVersion("10.0.426.12010")]
[assembly: System.Reflection.AssemblyInformationalVersion("10.0.4+80d3e14f5e08b4888f464e3cd0d0b2445b63ec46")]
...
namespace System.Collections.Frozen
{
    ...
    {
        public static FrozenDictionary<TKey, TValue> Create<TKey, TValue>(Generic.IEqualityComparer<TKey>? comparer, params scoped ReadOnlySpan<Generic.KeyValuePair<TKey, TValue>> source) where TKey : notnull { throw null; }
        public static FrozenDictionary<TKey, TValue> Create<TKey, TValue>(params scoped ReadOnlySpan<Generic.KeyValuePair<TKey, TValue>> source) where TKey : notnull { throw null; }
        public static FrozenDictionary<TKey, TSource> ToFrozenDictionary<TSource, TKey>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Generic.IEqualityComparer<TKey>? comparer = null) where TKey : notnull { throw null; }
        public static FrozenDictionary<TKey, TValue> ToFrozenDictionary<TKey, TValue>(this Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> source, Generic.IEqualityComparer<TKey>? comparer = null) where TKey : notnull { throw null; }
        public static FrozenDictionary<TKey, TElement> ToFrozenDictionary<TSource, TKey, TElement>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, Generic.IEqualityComparer<TKey>? comparer = null) where TKey : notnull { throw null; }
    }

    [Runtime.CompilerServices.CollectionBuilder(typeof(FrozenDictionary), "Create")]
    public abstract partial class FrozenDictionary<TKey, TValue> : Generic.IDictionary<TKey, TValue>, Generic.ICollection<Generic.KeyValuePair<TKey, TValue>>, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>>, IEnumerable, Generic.IReadOnlyDictionary<TKey, TValue>, Generic.IReadOnlyCollection<Generic.KeyValuePair<TKey, TValue>>, IDictionary, ICollection where TKey : notnull
    {
        internal FrozenDictionary() { }
        public Generic.IEqualityComparer<TKey> Comparer { get { throw null; } }
        public int Count { get { throw null; } }
        public static FrozenDictionary<TKey, TValue> Empty { get { throw null; } }
        public ref readonly TValue this[TKey key] { get { throw null; } }
        public Immutable.ImmutableArray<TKey> Keys { get { throw null; } }
        ...
        TValue Generic.IReadOnlyDictionary<TKey, TValue>.this[TKey key] { get { throw null; } }
        ...
        public Immutable.ImmutableArray<TValue> Values { get { throw null; } }
        public bool ContainsKey(TKey key) { throw null; }
        public void CopyTo(Generic.KeyValuePair<TKey, TValue>[] destination, int destinationIndex) { }
        public void CopyTo(Span<Generic.KeyValuePair<TKey, TValue>> destination) { }
        ...
        public readonly partial struct AlternateLookup<TAlternateKey>
                                                                                                                                                                 where TAlternateKey : notnull, allows ref struct
        {
            private readonly FrozenDictionary<TKey, TValue> _Dictionary_k__BackingField;
            private readonly object _dummy;
            private readonly int _dummyPrimitive;
            public FrozenDictionary<TKey, TValue> Dictionary { get { throw null; } }
            public TValue this[TAlternateKey key] { get { throw null; } }
            public readonly bool ContainsKey(TAlternateKey key) { throw null; }
            public readonly bool TryGetValue(TAlternateKey key, out TValue value) { throw null; }
        }
    ...
    {
        public static FrozenSet<T> Create<T>(Generic.IEqualityComparer<T>? equalityComparer, params scoped ReadOnlySpan<T> source) { throw null; }
        public static FrozenSet<T> Create<T>(params scoped ReadOnlySpan<T> source) { throw null; }
        public static FrozenSet<T> ToFrozenSet<T>(this Generic.IEnumerable<T> source, Generic.IEqualityComparer<T>? comparer = null) { throw null; }
    }

    [Runtime.CompilerServices.CollectionBuilder(typeof(FrozenSet), "Create")]
    public abstract partial class FrozenSet<T> : Generic.ISet<T>, Generic.ICollection<T>, Generic.IEnumerable<T>, IEnumerable, Generic.IReadOnlySet<T>, Generic.IReadOnlyCollection<T>, ICollection
    {
        internal FrozenSet() { }
        public Generic.IEqualityComparer<T> Comparer { get { throw null; } }
        public int Count { get { throw null; } }
        public static FrozenSet<T> Empty { get { throw null; } }
        public Immutable.ImmutableArray<T> Items { get { throw null; } }
        ...
        public AlternateLookup<TAlternate> GetAlternateLookup<TAlternate>() where TAlternate : allows ref struct { throw null; }
        public Enumerator GetEnumerator() { throw null; }
        ...
        void ICollection.CopyTo(Array array, int index) { }
        IEnumerator IEnumerable.GetEnumerator() { throw null; }
        public bool TryGetAlternateLookup<TAlternate>(out AlternateLookup<TAlternate> lookup) where TAlternate : allows ref struct { throw null; }
        ...
        {
            private readonly FrozenSet<T> _Set_k__BackingField;
            private readonly object _dummy;
            private readonly int _dummyPrimitive;
            public FrozenSet<T> Set { get { throw null; } }
            public readonly bool Contains(TAlternate item) { throw null; }
            public readonly bool TryGetValue(TAlternate equalValue, out T actualValue) { throw null; }
        }
...
namespace System.Collections.Immutable
{
    ...
    public static partial class ImmutableArray
    {
        ...
        public static ImmutableArray<T> Create<T>(params scoped ReadOnlySpan<T> items) { throw null; }
        [Runtime.CompilerServices.OverloadResolutionPriority(-1)]
        public static ImmutableArray<T> Create<T>(Span<T> items) { throw null; }
        ...
        public static ImmutableArray<TResult> CreateRange<TSource, TArg, TResult>(ImmutableArray<TSource> items, Func<TSource, TArg, TResult> selector, TArg arg) where TArg : allows ref struct { throw null; }
        public static ImmutableArray<TResult> CreateRange<TSource, TArg, TResult>(ImmutableArray<TSource> items, int start, int length, Func<TSource, TArg, TResult> selector, TArg arg) where TArg : allows ref struct { throw null; }
        ...
        public static ImmutableArray<T> ToImmutableArray<T>(this ReadOnlySpan<T> items) { throw null; }
        [Runtime.CompilerServices.OverloadResolutionPriority(-1)]
    ...
    public readonly partial struct ImmutableArray<T> : Generic.IReadOnlyList<T>, Generic.IEnumerable<T>, IEnumerable, Generic.IReadOnlyCollection<T>, Generic.IList<T>, Generic.ICollection<T>, IEquatable<ImmutableArray<T>>, IList, ICollection, IStructuralComparable, IStructuralEquatable, IImmutableList<T>
    {
        ...
        public readonly ImmutableArray<T> AddRange(T[] items, int length) { throw null; }
        public readonly ImmutableArray<T> AddRange(params T[] items) { throw null; }
        public readonly ImmutableArray<T> AddRange(Generic.IEnumerable<T> items) { throw null; }
        public readonly ImmutableArray<T> AddRange(ImmutableArray<T> items, int length) { throw null; }
        public readonly ImmutableArray<T> AddRange(ImmutableArray<T> items) { throw null; }
        public readonly ImmutableArray<T> AddRange(params scoped ReadOnlySpan<T> items) { throw null; }
        public readonly ImmutableArray<T> AddRange<TDerived>(TDerived[] items) where TDerived : T { throw null; }
        public readonly ImmutableArray<T> AddRange<TDerived>(ImmutableArray<TDerived> items) where TDerived : T { throw null; }
        public readonly ImmutableArray<TOther> As<TOther>() where TOther : class { throw null; }
        public readonly ReadOnlyMemory<T> AsMemory() { throw null; }
        public readonly ReadOnlySpan<T> AsSpan() { throw null; }
        public readonly ReadOnlySpan<T> AsSpan(int start, int length) { throw null; }
        public readonly ReadOnlySpan<T> AsSpan(Range range) { throw null; }
        public readonly ImmutableArray<TOther> CastArray<TOther>() where TOther : class { throw null; }
        public static ImmutableArray<T> CastUp<TDerived>(ImmutableArray<TDerived> items) where TDerived : class, T { throw null; }
        public readonly ImmutableArray<T> Clear() { throw null; }
        public readonly bool Contains(T item, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly bool Contains(T item) { throw null; }
        ...
        public readonly bool Equals(ImmutableArray<T> other) { throw null; }
        public override readonly bool Equals(object? obj) { throw null; }
        public readonly Enumerator GetEnumerator() { throw null; }
        public override readonly int GetHashCode() { throw null; }
        public readonly int IndexOf(T item, int startIndex, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly int IndexOf(T item, int startIndex, int count, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly int IndexOf(T item, int startIndex, int count) { throw null; }
        public readonly int IndexOf(T item, int startIndex) { throw null; }
        public readonly int IndexOf(T item) { throw null; }
        public readonly ImmutableArray<T> Insert(int index, T item) { throw null; }
        public readonly ImmutableArray<T> InsertRange(int index, T[] items) { throw null; }
        public readonly ImmutableArray<T> InsertRange(int index, Generic.IEnumerable<T> items) { throw null; }
        public readonly ImmutableArray<T> InsertRange(int index, ImmutableArray<T> items) { throw null; }
        public readonly ImmutableArray<T> InsertRange(int index, params scoped ReadOnlySpan<T> items) { throw null; }
        public readonly ref readonly T ItemRef(int index) { throw null; }
        public readonly int LastIndexOf(T item, int startIndex, int count, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly int LastIndexOf(T item, int startIndex, int count) { throw null; }
        public readonly int LastIndexOf(T item, int startIndex) { throw null; }
        public readonly int LastIndexOf(T item) { throw null; }
        public readonly Generic.IEnumerable<TResult> OfType<TResult>() { throw null; }
        public static bool operator ==(ImmutableArray<T> left, ImmutableArray<T> right) { throw null; }
        public static bool operator ==(ImmutableArray<T>? left, ImmutableArray<T>? right) { throw null; }
        public static bool operator !=(ImmutableArray<T> left, ImmutableArray<T> right) { throw null; }
        public static bool operator !=(ImmutableArray<T>? left, ImmutableArray<T>? right) { throw null; }
        public readonly ImmutableArray<T> Remove(T item, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly ImmutableArray<T> Remove(T item) { throw null; }
        public readonly ImmutableArray<T> RemoveAll(Predicate<T> match) { throw null; }
        public readonly ImmutableArray<T> RemoveAt(int index) { throw null; }
        public readonly ImmutableArray<T> RemoveRange(T[] items, Generic.IEqualityComparer<T>? equalityComparer = null) { throw null; }
        public readonly ImmutableArray<T> RemoveRange(Generic.IEnumerable<T> items, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly ImmutableArray<T> RemoveRange(Generic.IEnumerable<T> items) { throw null; }
        public readonly ImmutableArray<T> RemoveRange(ImmutableArray<T> items, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly ImmutableArray<T> RemoveRange(ImmutableArray<T> items) { throw null; }
        public readonly ImmutableArray<T> RemoveRange(int index, int length) { throw null; }
        public readonly ImmutableArray<T> RemoveRange(ReadOnlySpan<T> items, Generic.IEqualityComparer<T>? equalityComparer = null) { throw null; }
        public readonly ImmutableArray<T> Replace(T oldValue, T newValue, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public readonly ImmutableArray<T> Replace(T oldValue, T newValue) { throw null; }
        public readonly ImmutableArray<T> SetItem(int index, T item) { throw null; }
        public readonly ImmutableArray<T> Slice(int start, int length) { throw null; }
        public readonly ImmutableArray<T> Sort() { throw null; }
        public readonly ImmutableArray<T> Sort(Generic.IComparer<T>? comparer) { throw null; }
        public readonly ImmutableArray<T> Sort(Comparison<T> comparison) { throw null; }
        public readonly ImmutableArray<T> Sort(int index, int count, Generic.IComparer<T>? comparer) { throw null; }
        readonly void Generic.ICollection<T>.Add(T item) { }
        readonly void Generic.ICollection<T>.Clear() { }
        readonly bool Generic.ICollection<T>.Remove(T item) { throw null; }
        ...
        readonly IEnumerator IEnumerable.GetEnumerator() { throw null; }
        readonly int IList.Add(object value) { throw null; }
        ...
        readonly IImmutableList<T> IImmutableList<T>.AddRange(Generic.IEnumerable<T> items) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.Clear() { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.Insert(int index, T element) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.InsertRange(int index, Generic.IEnumerable<T> items) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.Remove(T value, Generic.IEqualityComparer<T> equalityComparer) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.RemoveAll(Predicate<T> match) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.RemoveAt(int index) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.RemoveRange(Generic.IEnumerable<T> items, Generic.IEqualityComparer<T> equalityComparer) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.RemoveRange(int index, int count) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.Replace(T oldValue, T newValue, Generic.IEqualityComparer<T> equalityComparer) { throw null; }
        readonly IImmutableList<T> IImmutableList<T>.SetItem(int index, T value) { throw null; }
        readonly int IStructuralComparable.CompareTo(object other, IComparer comparer) { throw null; }
        readonly bool IStructuralEquatable.Equals(object other, IEqualityComparer comparer) { throw null; }
        readonly int IStructuralEquatable.GetHashCode(IEqualityComparer comparer) { throw null; }
        public readonly Builder ToBuilder() { throw null; }
        public sealed partial class Builder : Generic.IList<T>, Generic.ICollection<T>, Generic.IEnumerable<T>, IEnumerable, Generic.IReadOnlyList<T>, Generic.IReadOnlyCollection<T>
        {
            ...
            public void AddRange<TDerived>(params scoped ReadOnlySpan<TDerived> items) where TDerived : T { }
            public void Clear() { }
            public bool Contains(T item) { throw null; }
            ...
            public void CopyTo(Span<T> destination) { }
            public ImmutableArray<T> DrainToImmutable() { throw null; }
            ...
            public bool Remove(T element, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
            public bool Remove(T element) { throw null; }
            public void RemoveAll(Predicate<T> match) { }
            public void RemoveAt(int index) { }
            public void RemoveRange(Generic.IEnumerable<T> items, Generic.IEqualityComparer<T>? equalityComparer) { }
            public void RemoveRange(Generic.IEnumerable<T> items) { }
            public void RemoveRange(int index, int length) { }
            public void Replace(T oldValue, T newValue, Generic.IEqualityComparer<T>? equalityComparer) { }
    ...
    {
        public static bool Contains<TKey, TValue>(this IImmutableDictionary<TKey, TValue> map, TKey key, TValue value) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> Create<TKey, TValue>() where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> Create<TKey, TValue>(Generic.IEqualityComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> Create<TKey, TValue>(Generic.IEqualityComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>() where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>(Generic.IEqualityComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>(Generic.IEqualityComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> CreateRange<TKey, TValue>(Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> CreateRange<TKey, TValue>(Generic.IEqualityComparer<TKey>? keyComparer, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> CreateRange<TKey, TValue>(Generic.IEqualityComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> CreateRangeWithOverwrite<TKey, TValue>(Generic.IEqualityComparer<TKey>? keyComparer, params scoped ReadOnlySpan<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> CreateRangeWithOverwrite<TKey, TValue>(params scoped ReadOnlySpan<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static TValue GetValueOrDefault<TKey, TValue>(this IImmutableDictionary<TKey, TValue> dictionary, TKey key, TValue defaultValue) where TKey : notnull { throw null; }
        public static TValue? GetValueOrDefault<TKey, TValue>(this IImmutableDictionary<TKey, TValue> dictionary, TKey key) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TSource> ToImmutableDictionary<TSource, TKey>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Generic.IEqualityComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TSource> ToImmutableDictionary<TSource, TKey>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TKey, TValue>(this Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> source, Generic.IEqualityComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TKey, TValue>(this Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> source, Generic.IEqualityComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TKey, TValue>(this Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> source) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TKey, TValue>(this ImmutableDictionary<TKey, TValue>.Builder builder) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TSource, TKey, TValue>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> elementSelector, Generic.IEqualityComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TSource, TKey, TValue>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> elementSelector, Generic.IEqualityComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableDictionary<TKey, TValue> ToImmutableDictionary<TSource, TKey, TValue>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> elementSelector) where TKey : notnull { throw null; }
    }

    [Runtime.CompilerServices.CollectionBuilder(typeof(ImmutableDictionary), "CreateRangeWithOverwrite")]
    ...
    public static partial class ImmutableHashSet
    {
        ...
        public static ImmutableHashSet<T> Create<T>(Generic.IEqualityComparer<T>? equalityComparer, params scoped ReadOnlySpan<T> items) { throw null; }
        public static ImmutableHashSet<T> Create<T>(Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
        public static ImmutableHashSet<T> Create<T>(params scoped ReadOnlySpan<T> items) { throw null; }
    ...
    {
        public static TValue AddOrUpdate<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, TValue addValue, Func<TKey, TValue, TValue> updateValueFactory) where TKey : notnull { throw null; }
        public static TValue AddOrUpdate<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, Func<TKey, TValue> addValueFactory, Func<TKey, TValue, TValue> updateValueFactory) where TKey : notnull { throw null; }
        public static void Enqueue<T>(ref ImmutableQueue<T> location, T value) { }
        public static TValue GetOrAdd<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, TValue value) where TKey : notnull { throw null; }
        public static TValue GetOrAdd<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, Func<TKey, TValue> valueFactory) where TKey : notnull { throw null; }
        public static TValue GetOrAdd<TKey, TValue, TArg>(ref ImmutableDictionary<TKey, TValue> location, TKey key, Func<TKey, TArg, TValue> valueFactory, TArg factoryArgument) where TKey : notnull where TArg : allows ref struct { throw null; }
        ...
        public static bool TryAdd<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, TValue value) where TKey : notnull { throw null; }
        ...
        public static bool TryRemove<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, out TValue value) where TKey : notnull { throw null; }
        public static bool TryUpdate<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, TValue newValue, TValue comparisonValue) where TKey : notnull { throw null; }
        public static bool Update<T>(ref T location, Func<T, T> transformer) where T : class { throw null; }
        public static bool Update<T>(ref ImmutableArray<T> location, Func<ImmutableArray<T>, ImmutableArray<T>> transformer) { throw null; }
        public static bool Update<T, TArg>(ref T location, Func<T, TArg, T> transformer, TArg transformerArgument) where T : class where TArg : allows ref struct { throw null; }
        public static bool Update<T, TArg>(ref ImmutableArray<T> location, Func<ImmutableArray<T>, TArg, ImmutableArray<T>> transformer, TArg transformerArgument) where TArg : allows ref struct { throw null; }
    }
    ...
    public static partial class ImmutableList
    {
        ...
        public static ImmutableList<T> Create<T>(params scoped ReadOnlySpan<T> items) { throw null; }
    ...
    public sealed partial class ImmutableList<T> : IImmutableList<T>, Generic.IReadOnlyList<T>, Generic.IEnumerable<T>, IEnumerable, Generic.IReadOnlyCollection<T>, Generic.IList<T>, Generic.ICollection<T>, IList, ICollection
    {
        ...
        public sealed partial class Builder : Generic.IList<T>, Generic.ICollection<T>, Generic.IEnumerable<T>, IEnumerable, IList, ICollection, Generic.IReadOnlyList<T>, Generic.IReadOnlyCollection<T>
        {
            ...
            public int LastIndexOf(T item, int startIndex) { throw null; }
            public int LastIndexOf(T item) { throw null; }
            public bool Remove(T item, Generic.IEqualityComparer<T>? equalityComparer) { throw null; }
            public bool Remove(T item) { throw null; }
    ...
    public static partial class ImmutableQueue
    {
        ...
        public static ImmutableQueue<T> Create<T>(params scoped ReadOnlySpan<T> items) { throw null; }
    ...
    {
        public static ImmutableSortedDictionary<TKey, TValue> Create<TKey, TValue>() where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> Create<TKey, TValue>(Generic.IComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> Create<TKey, TValue>(Generic.IComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>() where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>(Generic.IComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>(Generic.IComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> CreateRange<TKey, TValue>(Generic.IComparer<TKey>? keyComparer, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> CreateRange<TKey, TValue>(Generic.IComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> CreateRange<TKey, TValue>(Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> items) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TKey, TValue>(this Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> source, Generic.IComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TKey, TValue>(this Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> source, Generic.IComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TKey, TValue>(this Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>> source) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TKey, TValue>(this ImmutableSortedDictionary<TKey, TValue>.Builder builder) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TSource, TKey, TValue>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> elementSelector, Generic.IComparer<TKey>? keyComparer, Generic.IEqualityComparer<TValue>? valueComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TSource, TKey, TValue>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> elementSelector, Generic.IComparer<TKey>? keyComparer) where TKey : notnull { throw null; }
        public static ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TSource, TKey, TValue>(this Generic.IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TValue> elementSelector) where TKey : notnull { throw null; }
    }
    ...
    public static partial class ImmutableSortedSet
    {
        ...
        public static ImmutableSortedSet<T> Create<T>(Generic.IComparer<T>? comparer, params scoped ReadOnlySpan<T> items) { throw null; }
        public static ImmutableSortedSet<T> Create<T>(Generic.IComparer<T>? comparer) { throw null; }
        public static ImmutableSortedSet<T> Create<T>(params scoped ReadOnlySpan<T> items) { throw null; }
    ...
    public static partial class ImmutableStack
    {
        ...
        public static ImmutableStack<T> Create<T>(params scoped ReadOnlySpan<T> items) { throw null; }
...
namespace System.Linq
{
    public static partial class ImmutableArrayExtensions
    {
        ...
        public static bool SequenceEqual<TDerived, TBase>(this Collections.Immutable.ImmutableArray<TBase> immutableArray, Collections.Generic.IEnumerable<TDerived> items, Collections.Generic.IEqualityComparer<TBase>? comparer = null) where TDerived : TBase { throw null; }
        public static bool SequenceEqual<TDerived, TBase>(this Collections.Immutable.ImmutableArray<TBase> immutableArray, Collections.Immutable.ImmutableArray<TDerived> items, Collections.Generic.IEqualityComparer<TBase>? comparer = null) where TDerived : TBase { throw null; }
        public static bool SequenceEqual<TDerived, TBase>(this Collections.Immutable.ImmutableArray<TBase> immutableArray, Collections.Immutable.ImmutableArray<TDerived> items, Func<TBase, TBase, bool> predicate) where TDerived : TBase { throw null; }
        ...
        public static Collections.Generic.Dictionary<TKey, T> ToDictionary<TKey, T>(this Collections.Immutable.ImmutableArray<T> immutableArray, Func<T, TKey> keySelector, Collections.Generic.IEqualityComparer<TKey>? comparer) where TKey : notnull { throw null; }
        public static Collections.Generic.Dictionary<TKey, T> ToDictionary<TKey, T>(this Collections.Immutable.ImmutableArray<T> immutableArray, Func<T, TKey> keySelector) where TKey : notnull { throw null; }
...
namespace System.Runtime.InteropServices
{
    ...
    {
        public static T[]? AsArray<T>(Collections.Immutable.ImmutableArray<T> array) { throw null; }
        public static Collections.Immutable.ImmutableArray<T> AsImmutableArray<T>(T[]? array) { throw null; }
