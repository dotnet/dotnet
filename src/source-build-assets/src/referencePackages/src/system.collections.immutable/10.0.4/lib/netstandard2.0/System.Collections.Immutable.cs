...
namespace System.Collections.Frozen
{
    ...
    public abstract partial class FrozenSet<T> : Generic.ISet<T>, Generic.ICollection<T>, Generic.IEnumerable<T>, IEnumerable, Generic.IReadOnlyCollection<T>, ICollection
    {
        internal FrozenSet() { }
