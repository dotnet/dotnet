...
namespace NuGet.Commands
{
    ...
    public static partial class MSBuildRestoreUtility
    {
        ...
        public static ProjectModel.RestoreAuditProperties GetRestoreAuditProperties(IMSBuildItem specItem, System.Collections.Generic.IEnumerable<IMSBuildItem> allItems, System.Collections.Generic.HashSet<string> suppressionItems) { throw null; }
    ...
    public static partial class RestoreRunner
    {
        ...
        public static System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyList<RestoreResultPair>> RunWithoutCommitAsync(System.Collections.Generic.IEnumerable<RestoreSummaryRequest> restoreRequests, RestoreArgs restoreContext, System.Threading.CancellationToken cancellationToken) { throw null; }
    }
    ...
    {
        public static void ValidateDependencySpec(ProjectModel.DependencyGraphSpec spec, System.Collections.Generic.HashSet<string> projectsToSkip, Common.ILogger logger) { }
...
namespace NuGet.Commands.Restore
{
    ...
    public partial interface IProject
    {
        ...
        ITargetFramework OuterBuild { get; }

        System.Collections.Generic.IReadOnlyDictionary<string, ITargetFramework> TargetFrameworks { get; }
    }

    public partial interface ITargetFramework
    {
        System.Collections.Generic.IReadOnlyList<IItem> GetItems(string itemType);
...
{
    public static partial class PackageSpecFactory
    {
        public static ProjectModel.PackageSpec? GetPackageSpec(IProject project, Configuration.ISettings settings) { throw null; }
    }
}
