...
{
    [Framework.MSBuildMultiThreadableTask]
    public sealed partial class AddToWin32Manifest : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
        ...
        public Framework.TaskEnvironment TaskEnvironment { get { throw null; } set { } }
    ...
    public partial class AssignCulture : TaskExtension
    {
        ...
        public bool WarnOnCultureOverwritten { get { throw null; } set { } }
        public override bool Execute() { throw null; }
    }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class AssignTargetPath : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class Copy : TaskExtension, Framework.IIncrementalTask, Framework.ICancelableTask, Framework.ITask, Framework.IMultiThreadableTask
    {
        public Copy() { }
        [Framework.Output]
    ...
    public abstract partial class CreateManifestResourceName : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
        ...
        public bool EnableCustomCulture { get { throw null; } set { } }
        [Framework.Output]
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class Delete : TaskExtension, Framework.ICancelableTask, Framework.ITask, Framework.IIncrementalTask, Framework.IMultiThreadableTask
    {
        public Delete() { }
        [Framework.Output]
    ...
    [Framework.MSBuildMultiThreadableTask]
    public sealed partial class DownloadFile : TaskExtension, Framework.ICancelableTask, Framework.ITask, Framework.IIncrementalTask, Framework.IMultiThreadableTask
    {
        public DownloadFile() { }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class FindUnderPath : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    public abstract partial class GenerateManifestBase : Utilities.Task, Framework.IMultiThreadableTask, Framework.ITask
    {
        public string AssemblyName { get { throw null; } set { } }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public sealed partial class GetFileHash : TaskExtension, Framework.ICancelableTask, Framework.ITask, Framework.IMultiThreadableTask
    {
        public GetFileHash() { }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class GetInstalledSDKLocations : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class GetReferenceAssemblyPaths : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class MakeDir : TaskExtension, Framework.IIncrementalTask, Framework.IMultiThreadableTask, Framework.ITask
    {
        public MakeDir() { }
        [Framework.Required]
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class Move : TaskExtension, Framework.ICancelableTask, Framework.ITask, Framework.IIncrementalTask, Framework.IMultiThreadableTask
    {
        public Move() { }
        [Framework.Output]
        public Framework.ITaskItem[] DestinationFiles { get { throw null; } set { } }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class ReadLinesFromFile : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class RemoveDir : TaskExtension, Framework.IIncrementalTask, Framework.IMultiThreadableTask, Framework.ITask
    {
        public RemoveDir() { }
        [Framework.Required]
        public Framework.ITaskItem[] Directories { get { throw null; } set { } }
    ...
    public partial class ResolveAssemblyReference : TaskExtension, Framework.IIncrementalTask
    {
        ...
        public bool AllowOutOfProcNode { get { throw null; } set { } }
        ...
        public string[] NonCultureResourceDirectories { get { throw null; } set { } }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public sealed partial class ResolveManifestFiles : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    public sealed partial class RoslynCodeTaskFactory : Framework.ITaskFactory
    {
        ...
        public void CleanupTask(Framework.ITask task) { }
        public Framework.ITask CreateTask(Framework.IBuildEngine taskFactoryLoggingHost) { throw null; }
        public string GetAssemblyPath() { throw null; }
        public Framework.TaskPropertyInfo[] GetTaskParameters() { throw null; }
        public bool Initialize(string taskName, System.Collections.Generic.IDictionary<string, Framework.TaskPropertyInfo> parameterGroup, string taskBody, Framework.IBuildEngine taskFactoryLoggingHost) { throw null; }
    }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class Touch : TaskExtension, Framework.IIncrementalTask, Framework.IMultiThreadableTask, Framework.ITask
    {
        public Touch() { }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public sealed partial class Unzip : TaskExtension, Framework.ICancelableTask, Framework.ITask, Framework.IIncrementalTask, Framework.IMultiThreadableTask
    {
        public Unzip() { }
        [Framework.Required]
        public Framework.ITaskItem DestinationFolder { get { throw null; } set { } }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public sealed partial class VerifyFileHash : TaskExtension, Framework.ICancelableTask, Framework.ITask, Framework.IMultiThreadableTask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class WriteCodeFragment : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class WriteLinesToFile : TaskExtension, Framework.IIncrementalTask, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class XmlPeek : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
        public XmlPeek() { }
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class XmlPoke : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
        public XmlPoke() { }
        public string Namespaces { get { throw null; } set { } }
        [Framework.Required]
    ...
    [Framework.MSBuildMultiThreadableTask]
    public partial class XslTransformation : TaskExtension, Framework.IMultiThreadableTask, Framework.ITask
    {
    ...
    [Framework.MSBuildMultiThreadableTask]
    public sealed partial class ZipDirectory : TaskExtension, Framework.IIncrementalTask, Framework.IMultiThreadableTask, Framework.ITask
    {
        ...
        public ZipDirectory() { }
        public string? CompressionLevel { get { throw null; } set { } }
        [Framework.Required]
...
{
    public sealed partial class OutOfProcRarNode
    {
        public OutOfProcRarNode() { }
        public OutOfProcRarNode(int maxNumberOfConcurrentTasks) { }
        public RarNodeShutdownReason Run(out System.Exception? shutdownException, System.Threading.CancellationToken cancellationToken = default) { throw null; }
    }
