...
namespace System.Formats.Asn1
{
    ...
    public sealed partial class AsnWriter
    {
        ...
        public void Encode<TState>(TState state, Action<TState, ReadOnlySpan<byte>> encodeCallback) where TState : allows ref struct { }
        public TReturn Encode<TReturn>(Func<ReadOnlySpan<byte>, TReturn> encodeCallback) { throw null; }
        public TReturn Encode<TState, TReturn>(TState state, Func<TState, ReadOnlySpan<byte>, TReturn> encodeCallback) where TState : allows ref struct { throw null; }
