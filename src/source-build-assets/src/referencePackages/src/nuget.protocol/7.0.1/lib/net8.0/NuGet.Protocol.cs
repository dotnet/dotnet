...
namespace NuGet.Protocol
{
    ...
    public partial class HttpSourceException : Core.Types.FatalProtocolException
    {
        public HttpSourceException(string message, System.Exception innerException) : base(default!) { }
        public HttpSourceException(string message) : base(default!) { }
    }
    ...
    public partial class LocalPackageSearchMetadata : Core.Types.IPackageSearchMetadata
    {
        ...
        public string ReadmeFileUrl { get { throw null; } }
    ...
    public partial class PackageVulnerabilityMetadata
    {
        ...
        public PackageVulnerabilityMetadata(System.Uri advisoryUrl, int severity) { }
...
namespace NuGet.Protocol.Core.Types
{
    ...
    public partial class PackageSearchMetadataBuilder
    {
        ...
        public partial class ClonedPackageSearchMetadata : IPackageSearchMetadata
        {
            ...
            public string ReadmeFileUrl { get { throw null; } set { } }
    ...
    public partial class PackageUpdateResource : INuGetResource
    {
        ...
        public System.Threading.Tasks.Task PushAsync(System.Collections.Generic.IList<string> packagePaths, string symbolSource, int timeoutInSecond, bool disableBuffering, System.Func<string, string> getApiKey, System.Func<string, string> getSymbolApiKey, bool noServiceEndpoint, bool skipDuplicate, bool allowSnupkg, bool allowInsecureConnections, Common.ILogger log) { throw null; }
    }
    ...
    public partial class SourceRepository
    {
        ...
        public virtual T GetResource<T>() where T : class, INuGetResource { throw null; }
        public virtual T GetResource<T>(System.Threading.CancellationToken token) where T : class, INuGetResource { throw null; }
        public virtual System.Threading.Tasks.Task<T> GetResourceAsync<T>() where T : class, INuGetResource { throw null; }
        public virtual System.Threading.Tasks.Task<T> GetResourceAsync<T>(System.Threading.CancellationToken token) where T : class, INuGetResource { throw null; }
        public override string ToString() { throw null; }
    }
...
namespace NuGet.Protocol.Events
{
    ...
    public sealed partial class ProtocolDiagnosticServiceIndexEntryEvent
    {
        public ProtocolDiagnosticServiceIndexEntryEvent(string source, bool httpsSourceHasHttpResource) { }
        public bool HttpsSourceHasHttpResource { get { throw null; } }
        public string Source { get { throw null; } }
    }
}
...
namespace NuGet.Protocol.Plugins
{
    ...
    public sealed partial class Connection : IConnection, System.IDisposable
    {
        ...
        public event System.EventHandler<ProtocolErrorEventArgs> Faulted {
            add { }
            remove { }
        }
        ...
        public System.Threading.Tasks.Task<TInbound> SendRequestAndReceiveResponseAsync<TOutbound, TInbound>(MessageMethod method, TOutbound payload, System.Threading.CancellationToken cancellationToken) where TOutbound : class where TInbound : class { throw null; }
    }
    ...
    public sealed partial class MessageDispatcher : IMessageDispatcher, System.IDisposable, IResponseHandler
    {
        ...
        public Message CreateMessage<TPayload>(MessageType type, MessageMethod method, TPayload payload) where TPayload : class { throw null; }
        ...
        public System.Threading.Tasks.Task<TInbound> DispatchRequestAsync<TOutbound, TInbound>(MessageMethod method, TOutbound payload, System.Threading.CancellationToken cancellationToken) where TOutbound : class where TInbound : class { throw null; }
        public System.Threading.Tasks.Task DispatchResponseAsync<TOutbound>(Message request, TOutbound responsePayload, System.Threading.CancellationToken cancellationToken) where TOutbound : class { throw null; }
        public void Dispose() { }
    ...
    public static partial class MessageUtilities
    {
        ...
        public static Message Create<TPayload>(string requestId, MessageType type, MessageMethod method, TPayload payload) where TPayload : class { throw null; }
    ...
    public sealed partial class NoOpDisposePlugin : IPlugin, System.IDisposable
    {
        ...
        public event System.EventHandler BeforeClose {
            add { }
            remove { }
        }
    ...
    public sealed partial class Plugin : IPlugin, System.IDisposable
    {
        ...
        public event System.EventHandler<PluginEventArgs> Exited {
            add { }
            remove { }
        }

        public event System.EventHandler<FaultedPluginEventArgs> Faulted {
            add { }
            remove { }
        }

        public event System.EventHandler<PluginEventArgs> Idle {
            add { }
            remove { }
        }
    ...
    public partial class PluginFactory : System.IDisposable
    {
        ...
        public virtual System.Threading.Tasks.Task<IPlugin> GetOrCreateAsync(PluginFile pluginFile, System.Collections.Generic.IEnumerable<string> arguments, IRequestHandlers requestHandlers, ConnectionOptions options, System.Threading.CancellationToken sessionCancellationToken) { throw null; }
    }

    public sealed partial class PluginFile
    {
        public PluginFile(string filePath, System.Lazy<PluginFileState> state, bool requiresDotnetHost) { }
    ...
    {
        public PluginManager(Common.IEnvironmentVariableReader reader, System.Lazy<IPluginDiscoverer> pluginDiscoverer, System.Func<System.TimeSpan, PluginFactory> pluginFactoryCreator, System.Lazy<string> pluginsCacheDirectoryPath) { }
    ...
    public sealed partial class PluginProcess : IPluginProcess, System.IDisposable
    {
        ...
        public event System.EventHandler<IPluginProcess> Exited {
            add { }
            remove { }
        }

        public event System.EventHandler<LineReadEventArgs> LineRead {
            add { }
            remove { }
        }
