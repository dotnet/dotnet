...
namespace NuGet.Configuration
{
    ...
    public partial class PackageSourceProvider : IPackageSourceProvider
    {
        ...
        public event System.EventHandler? PackageSourcesChanged {
            add { }
            remove { }
        }
    ...
    public abstract partial class SettingSection : SettingsGroup<SettingItem>
    {
        ...
        public override bool Equals(object? other) { throw null; }
        public T? GetFirstItemWithAttribute<T>(string attributeName, string expectedAttributeValue) where T : SettingItem { throw null; }
        public override int GetHashCode() { throw null; }
    }
