...
[assembly: System.Reflection.AssemblyFileVersion("4.600.24.56208")]
[assembly: System.Reflection.AssemblyInformationalVersion("4.6.0+d0c2a5a83211e271826172a6b0510c25a52dbd53")]
...
namespace System.Numerics
{
    ...
    public static partial class Vector
    {
        ...
        public static Vector<byte> AsVectorByte<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<double> AsVectorDouble<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<short> AsVectorInt16<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<int> AsVectorInt32<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<long> AsVectorInt64<T>(Vector<T> value) where T : struct { throw null; }
        [CLSCompliant(false)]
        public static Vector<sbyte> AsVectorSByte<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<float> AsVectorSingle<T>(Vector<T> value) where T : struct { throw null; }
        [CLSCompliant(false)]
        public static Vector<ushort> AsVectorUInt16<T>(Vector<T> value) where T : struct { throw null; }
        [CLSCompliant(false)]
        public static Vector<uint> AsVectorUInt32<T>(Vector<T> value) where T : struct { throw null; }
        [CLSCompliant(false)]
        public static Vector<ulong> AsVectorUInt64<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<T> BitwiseAnd<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static Vector<T> BitwiseOr<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> ConditionalSelect<T>(Vector<T> condition, Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> Divide<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static T Dot<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> Equals<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool EqualsAll<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool EqualsAny<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> GreaterThan<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool GreaterThanAll<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool GreaterThanAny<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> GreaterThanOrEqual<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool GreaterThanOrEqualAll<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool GreaterThanOrEqualAny<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> LessThan<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool LessThanAll<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool LessThanAny<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> LessThanOrEqual<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool LessThanOrEqualAll<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static bool LessThanOrEqualAny<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static Vector<T> Max<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static Vector<T> Min<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        public static Vector<T> Multiply<T>(T left, Vector<T> right) where T : struct { throw null; }
        public static Vector<T> Multiply<T>(Vector<T> left, T right) where T : struct { throw null; }
        public static Vector<T> Multiply<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        ...
        public static Vector<T> Negate<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<T> OnesComplement<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<T> SquareRoot<T>(Vector<T> value) where T : struct { throw null; }
        public static Vector<T> Subtract<T>(Vector<T> left, Vector<T> right) where T : struct { throw null; }
        [CLSCompliant(false)]
