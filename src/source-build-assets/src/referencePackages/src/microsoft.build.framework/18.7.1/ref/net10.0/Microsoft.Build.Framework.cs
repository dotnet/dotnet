...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Microsoft.Build.EndToEnd.Tests, PublicKey=")]
...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("MSBuild.Benchmarks, PublicKey=")]
...
{
    public readonly partial struct AbsolutePath : System.IEquatable<AbsolutePath>
    {
        private readonly object _dummy;
        private readonly int _dummyPrimitive;
        public AbsolutePath(string path, AbsolutePath basePath) { }
        public AbsolutePath(string path) { }
        public string OriginalValue { get { throw null; } }
        public string Value { get { throw null; } }
        public readonly bool Equals(AbsolutePath other) { throw null; }
        public override readonly bool Equals(object? obj) { throw null; }
        public override readonly int GetHashCode() { throw null; }
        public static bool operator ==(AbsolutePath left, AbsolutePath right) { throw null; }
        public static implicit operator string(AbsolutePath path) { throw null; }
        public static bool operator !=(AbsolutePath left, AbsolutePath right) { throw null; }
    ...
    public sealed partial class BuildSubmissionStartedEventArgs : BuildStatusEventArgs
    {
        ...
        public BuildSubmissionStartedEventArgs(System.Collections.Generic.IReadOnlyDictionary<string, string?> globalProperties, System.Collections.Generic.IEnumerable<string> entryProjectsFullPath, System.Collections.Generic.IEnumerable<string> targetNames, Execution.BuildRequestDataFlags flags, int submissionId) { }
        public System.Collections.Generic.IEnumerable<string> EntryProjectsFullPath { get { throw null; } set { } }
        public Execution.BuildRequestDataFlags Flags { get { throw null; } set { } }
        public System.Collections.Generic.IReadOnlyDictionary<string, string?> GlobalProperties { get { throw null; } set { } }
        public int SubmissionId { get { throw null; } set { } }
        public System.Collections.Generic.IEnumerable<string> TargetNames { get { throw null; } set { } }
    }
    ...
    public abstract partial class EngineServices
    {
        ...
        public virtual bool IsOutOfProcRarNodeEnabled { get { throw null; } }
    ...
    public partial class EnvironmentVariableReadEventArgs : BuildMessageEventArgs
    {
        ...
        public EnvironmentVariableReadEventArgs(string environmentVarName, string message, string file, int line, int column) { }
    ...
    public sealed partial class ExtendedBuildErrorEventArgs : BuildErrorEventArgs, IExtendedBuildEventArgs
    {
        ...
        public System.Collections.Generic.Dictionary<string, string?>? ExtendedMetadata { get { throw null; } set { } }
    ...
    public partial interface IItemData
    {
        ...
        System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<string, string>> EnumerateMetadata();
    }
    ...
    public partial interface IMultiThreadableTask : ITask
    {
    ...
    public partial interface ITaskFactory3 : ITaskFactory2, ITaskFactory
    {
        ITask CreateTask(IBuildEngine taskFactoryLoggingHost, TaskHostParameters taskIdentityParameters);
        bool Initialize(string taskName, TaskHostParameters factoryIdentityParameters, System.Collections.Generic.IDictionary<string, TaskPropertyInfo> parameterGroup, string taskBody, IBuildEngine taskFactoryLoggingHost);
    }
    ...
    public readonly partial struct ItemData
    {
        ...
        public readonly System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<string, string>> EnumerateMetadata() { throw null; }
    }
    ...
    public partial class MSBuildMultiThreadableTaskAttribute : System.Attribute
    {
    }
    ...
    public readonly partial struct PropertyData : System.IEquatable<PropertyData>
    {
        private readonly object _dummy;
        private readonly int _dummyPrimitive;
        ...
        public readonly void Deconstruct(out string Name, out string Value) { throw null; }
        public readonly bool Equals(PropertyData other) { throw null; }
        public override readonly bool Equals(object obj) { throw null; }
        public override readonly int GetHashCode() { throw null; }
        public static bool operator ==(PropertyData left, PropertyData right) { throw null; }
        public static bool operator !=(PropertyData left, PropertyData right) { throw null; }
        public override readonly string ToString() { throw null; }
    }
    ...
    public partial class PropertyInitialValueSetEventArgs : BuildMessageEventArgs
    {
        ...
        public PropertyInitialValueSetEventArgs(string propertyName, string propertyValue, string propertySource, string file, int line, int column, string message, string helpKeyword = null, string senderName = null, MessageImportance importance = MessageImportance.Low) { }
    ...
    public partial class PropertyReassignmentEventArgs : BuildMessageEventArgs
    {
        ...
        public PropertyReassignmentEventArgs(string propertyName, string previousValue, string newValue, string location, string file, int line, int column, string message, string helpKeyword = null, string senderName = null, MessageImportance importance = MessageImportance.Low) { }
    ...
    public abstract partial class SdkResult
    {
        ...
        public virtual System.Collections.Generic.IDictionary<string, string> EnvironmentVariablesToAdd { get { throw null; } protected set { } }
    ...
    public abstract partial class SdkResultFactory
    {
        ...
        public virtual SdkResult IndicateSuccess(System.Collections.Generic.IEnumerable<string> paths, string version, System.Collections.Generic.IDictionary<string, string> propertiesToAdd = null, System.Collections.Generic.IDictionary<string, SdkResultItem> itemsToAdd = null, System.Collections.Generic.IEnumerable<string> warnings = null, System.Collections.Generic.IDictionary<string, string> environmentVariablesToAdd = null) { throw null; }
        public virtual SdkResult IndicateSuccess(System.Collections.Generic.IEnumerable<string> paths, string version, System.Collections.Generic.IDictionary<string, string> propertiesToAdd, System.Collections.Generic.IDictionary<string, SdkResultItem> itemsToAdd, System.Collections.Generic.IEnumerable<string> warnings) { throw null; }
        public virtual SdkResult IndicateSuccess(string path, string version, System.Collections.Generic.IDictionary<string, string> propertiesToAdd, System.Collections.Generic.IDictionary<string, SdkResultItem> itemsToAdd, System.Collections.Generic.IEnumerable<string> warnings = null, System.Collections.Generic.IDictionary<string, string> environmentVariablesToAdd = null) { throw null; }
    ...
    public sealed partial class TaskEnvironment
    {
        internal TaskEnvironment() { }
        public static TaskEnvironment Fallback { get { throw null; } }
        public AbsolutePath ProjectDirectory { get { throw null; } }
        public static TaskEnvironment CreateWithProjectDirectoryAndEnvironment(string projectDirectory, System.Collections.Generic.IDictionary<string, string>? environmentVariables = null) { throw null; }
        public AbsolutePath GetAbsolutePath(string path) { throw null; }
        public string? GetEnvironmentVariable(string name) { throw null; }
        public System.Collections.Generic.IReadOnlyDictionary<string, string> GetEnvironmentVariables() { throw null; }
        public System.Diagnostics.ProcessStartInfo GetProcessStartInfo() { throw null; }
    ...
    public readonly partial struct TaskHostParameters : System.IEquatable<TaskHostParameters>
    {
        private readonly object _dummy;
        private readonly int _dummyPrimitive;
        public static readonly TaskHostParameters Empty;
        public string? Architecture { get { throw null; } }
        public string? DotnetHostPath { get { throw null; } }
        public string? MSBuildAssemblyPath { get { throw null; } }
        public string? Runtime { get { throw null; } }
        public bool? TaskHostFactoryExplicitlyRequested { get { throw null; } }
        public readonly bool Equals(TaskHostParameters other) { throw null; }
        public override readonly bool Equals(object? obj) { throw null; }
        public override readonly int GetHashCode() { throw null; }
    }
