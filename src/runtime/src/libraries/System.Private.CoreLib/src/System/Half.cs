...
#pragma warning restore CS1718
        ...
        static bool INumberBase<Half>.TryParse([NotNullWhen(true)] string? s, NumberStyles style, IFormatProvider? provider, out Half result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleFloatingPoint(style);
        ...
        static bool INumberBase<Half>.TryParse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, out Half result, out int charsConsumed)
        {
            NumberFormatInfo.ValidateParseStyleFloatingPoint(style);
        ...
        static bool INumberBase<Half>.TryParse(ReadOnlySpan<byte> utf8Text, NumberStyles style, IFormatProvider? provider, out Half result, out int bytesConsumed)
        {
            NumberFormatInfo.ValidateParseStyleFloatingPoint(style);
