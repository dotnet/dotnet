...
[assembly: System.Reflection.AssemblyDescription("System.Configuration.ConfigurationManager")]
...
namespace System.Configuration
{
    ...
    public sealed partial class AppSettingsSection : ConfigurationSection
    {
        ...
        protected override ConfigurationPropertyCollection Properties { get { throw null; } }

        public KeyValueConfigurationCollection Settings { get { throw null; } }

        protected override void DeserializeElement(Xml.XmlReader reader, bool serializeCollectionKey) { }
        ...
        protected override string SerializeSection(ConfigurationElement parentElement, string name, ConfigurationSaveMode saveMode) { throw null; }
    }
    ...
    public abstract partial class ConfigurationElement
    {
        ...
        protected virtual ConfigurationElementProperty ElementProperty { get { throw null; } }

        protected ContextInformation EvaluationContext { get { throw null; } }

        protected bool HasContext { get { throw null; } }

        protected object this[ConfigurationProperty prop] { get { throw null; } set { } }
        ...
        protected virtual ConfigurationPropertyCollection Properties { get { throw null; } }

        protected virtual void DeserializeElement(Xml.XmlReader reader, bool serializeCollectionKey) { }
        ...
        protected virtual bool SerializeElement(Xml.XmlWriter writer, bool serializeCollectionKey) { throw null; }

        protected virtual bool SerializeToXmlElement(Xml.XmlWriter writer, string elementName) { throw null; }
    ...
    public abstract partial class ConfigurationElementCollection : ConfigurationElement, Collections.ICollection, Collections.IEnumerable
    {
        ...
        protected ConfigurationElement BaseGet(int index) { throw null; }

        protected ConfigurationElement BaseGet(object key) { throw null; }
        ...
        protected override bool SerializeElement(Xml.XmlWriter writer, bool serializeCollectionKey) { throw null; }
    ...
    public abstract partial class ConfigurationSection : ConfigurationElement
    {
        ...
        protected virtual void DeserializeSection(Xml.XmlReader reader) { }
        ...
        protected virtual string SerializeSection(ConfigurationElement parentElement, string name, ConfigurationSaveMode saveMode) { throw null; }

        protected virtual bool ShouldSerializeElementInTargetVersion(ConfigurationElement element, string elementName, Runtime.Versioning.FrameworkName targetFramework) { throw null; }

        protected virtual bool ShouldSerializePropertyInTargetVersion(ConfigurationProperty property, string propertyName, Runtime.Versioning.FrameworkName targetFramework, ConfigurationElement parentConfigurationElement) { throw null; }

        protected virtual bool ShouldSerializeSectionInTargetVersion(Runtime.Versioning.FrameworkName targetFramework) { throw null; }
    }
    ...
    public sealed partial class ConfigurationSectionCollection : Collections.Specialized.NameObjectCollectionBase
    {
        ...
        public override KeysCollection Keys { get { throw null; } }
    ...
    public partial class ConfigurationSectionGroup
    {
        ...
        protected virtual bool ShouldSerializeSectionGroupInTargetVersion(Runtime.Versioning.FrameworkName targetFramework) { throw null; }
    }
    ...
    public sealed partial class DefaultSection : ConfigurationSection
    {
        ...
        protected override void DeserializeSection(Xml.XmlReader xmlReader) { }
        ...
        protected override string SerializeSection(ConfigurationElement parentSection, string name, ConfigurationSaveMode saveMode) { throw null; }
    }
    ...
    public partial class SettingsPropertyCollection : Collections.ICollection, Collections.IEnumerable, ICloneable
    {
    ...
    public partial class SettingsPropertyValueCollection : Collections.ICollection, Collections.IEnumerable, ICloneable
    {
    ...
    public sealed partial class SettingValueElement : ConfigurationElement
    {
        ...
        protected override bool SerializeToXmlElement(Xml.XmlWriter writer, string elementName) { throw null; }
