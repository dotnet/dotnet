...
namespace System.Diagnostics
{
    public partial class Activity : IDisposable
    {
        ...
        public Activity AddLink(ActivityLink link) { throw null; }
    ...
    public sealed partial class ActivityListener : IDisposable
    {
        ...
        public ExceptionRecorder? ExceptionRecorder { get { throw null; } set { } }
    ...
    {
        public ActivitySource(string name, string? version = "", Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags = null) { }
...
namespace System.Diagnostics.Metrics
{
    ...
    {
        internal Counter() : base(default!, default!) { }
        ...
        public void Add(T delta, params scoped ReadOnlySpan<Collections.Generic.KeyValuePair<string, object?>> tags) { }
        public void Add(T delta) { }
    }

    public sealed partial class Gauge<T> : Instrument<T> where T : struct
    {
        internal Gauge() : base(default!, default!) { }
        ...
        public void Record(T value, params scoped ReadOnlySpan<Collections.Generic.KeyValuePair<string, object?>> tags) { }
        public void Record(T value) { }
    }

    public sealed partial class Histogram<T> : Instrument<T> where T : struct
    {
        internal Histogram() : base(default!, default!) { }
        public void Record(T value, Collections.Generic.KeyValuePair<string, object?> tag1, Collections.Generic.KeyValuePair<string, object?> tag2, Collections.Generic.KeyValuePair<string, object?> tag3) { }
        public void Record(T value, Collections.Generic.KeyValuePair<string, object?> tag1, Collections.Generic.KeyValuePair<string, object?> tag2) { }
        public void Record(T value, Collections.Generic.KeyValuePair<string, object?> tag) { }
        public void Record(T value, params Collections.Generic.KeyValuePair<string, object?>[] tags) { }
    ...
    {
        protected Instrument(Meter meter, string name, string? unit = null, string? description = null, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags = null) { }
    ...
    public abstract partial class Instrument<T> : Instrument where T : struct
    {
        ...
        protected Instrument(Meter meter, string name, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) : base(default!, default!) { }
        ...
        where T : struct
    {
        ...
        public Measurement(T value, params scoped ReadOnlySpan<Collections.Generic.KeyValuePair<string, object?>> tags) { }
    ...
    public partial class Meter : IDisposable
    {
        ...
        public Histogram<T> CreateHistogram<T>(string name, string? unit = null, string? description = null, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags = null, InstrumentAdvice<T>? advice = null) where T : struct { throw null; }
        public Histogram<T> CreateHistogram<T>(string name, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        ...
        public ObservableCounter<T> CreateObservableCounter<T>(string name, Func<T> observeValue, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableCounter<T> CreateObservableCounter<T>(string name, Func<T> observeValue, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableCounter<T> CreateObservableCounter<T>(string name, Func<Collections.Generic.IEnumerable<Measurement<T>>> observeValues, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableCounter<T> CreateObservableCounter<T>(string name, Func<Collections.Generic.IEnumerable<Measurement<T>>> observeValues, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableCounter<T> CreateObservableCounter<T>(string name, Func<Measurement<T>> observeValue, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableCounter<T> CreateObservableCounter<T>(string name, Func<Measurement<T>> observeValue, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableGauge<T> CreateObservableGauge<T>(string name, Func<T> observeValue, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableGauge<T> CreateObservableGauge<T>(string name, Func<T> observeValue, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableGauge<T> CreateObservableGauge<T>(string name, Func<Collections.Generic.IEnumerable<Measurement<T>>> observeValues, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableGauge<T> CreateObservableGauge<T>(string name, Func<Collections.Generic.IEnumerable<Measurement<T>>> observeValues, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableGauge<T> CreateObservableGauge<T>(string name, Func<Measurement<T>> observeValue, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableGauge<T> CreateObservableGauge<T>(string name, Func<Measurement<T>> observeValue, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableUpDownCounter<T> CreateObservableUpDownCounter<T>(string name, Func<T> observeValue, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableUpDownCounter<T> CreateObservableUpDownCounter<T>(string name, Func<T> observeValue, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableUpDownCounter<T> CreateObservableUpDownCounter<T>(string name, Func<Collections.Generic.IEnumerable<Measurement<T>>> observeValues, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableUpDownCounter<T> CreateObservableUpDownCounter<T>(string name, Func<Collections.Generic.IEnumerable<Measurement<T>>> observeValues, string? unit = null, string? description = null) where T : struct { throw null; }
        public ObservableUpDownCounter<T> CreateObservableUpDownCounter<T>(string name, Func<Measurement<T>> observeValue, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
        public ObservableUpDownCounter<T> CreateObservableUpDownCounter<T>(string name, Func<Measurement<T>> observeValue, string? unit = null, string? description = null) where T : struct { throw null; }
        public UpDownCounter<T> CreateUpDownCounter<T>(string name, string? unit, string? description, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags) where T : struct { throw null; }
    ...
    {
        internal UpDownCounter() : base(default!, default!) { }
        public void Add(T delta, Collections.Generic.KeyValuePair<string, object?> tag1, Collections.Generic.KeyValuePair<string, object?> tag2, Collections.Generic.KeyValuePair<string, object?> tag3) { }
        public void Add(T delta, Collections.Generic.KeyValuePair<string, object?> tag1, Collections.Generic.KeyValuePair<string, object?> tag2) { }
        public void Add(T delta, Collections.Generic.KeyValuePair<string, object?> tag) { }
        public void Add(T delta, params Collections.Generic.KeyValuePair<string, object?>[] tags) { }
