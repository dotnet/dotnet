...
namespace System.Diagnostics.Metrics
{
    ...
    public sealed partial class InstrumentAdvice<T>
        where T : struct
    {
    ...
    public partial class Meter : IDisposable
    {
        ...
        public Gauge<T> CreateGauge<T>(string name, string? unit = null, string? description = null, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags = null)
            where T : struct { throw null; }

        public Gauge<T> CreateGauge<T>(string name)
            where T : struct { throw null; }

        public Histogram<T> CreateHistogram<T>(string name, string? unit = null, string? description = null, Collections.Generic.IEnumerable<Collections.Generic.KeyValuePair<string, object?>>? tags = null, InstrumentAdvice<T>? advice = null)
            where T : struct { throw null; }
        ...
        public Histogram<T> CreateHistogram<T>(string name, string? unit, string? description)
            where T : struct { throw null; }

        public Histogram<T> CreateHistogram<T>(string name)
            where T : struct { throw null; }
