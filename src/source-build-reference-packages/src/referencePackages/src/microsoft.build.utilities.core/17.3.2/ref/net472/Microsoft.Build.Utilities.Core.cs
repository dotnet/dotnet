...
namespace Microsoft.Build.Utilities
{
    ...
    {
        public CanonicalTrackedInputFiles(Framework.ITask ownerTask, Framework.ITaskItem[] tlogFiles, Framework.ITaskItem sourceFile, Framework.ITaskItem[] excludedInputPaths, CanonicalTrackedOutputFiles outputs, bool useMinimalRebuildOptimization, bool maintainCompositeRootingMarkers) { }

        public CanonicalTrackedInputFiles(Framework.ITask ownerTask, Framework.ITaskItem[] tlogFiles, Framework.ITaskItem[] sourceFiles, Framework.ITaskItem[] excludedInputPaths, Framework.ITaskItem[] outputs, bool useMinimalRebuildOptimization, bool maintainCompositeRootingMarkers) { }

        public CanonicalTrackedInputFiles(Framework.ITask ownerTask, Framework.ITaskItem[] tlogFiles, Framework.ITaskItem[] sourceFiles, Framework.ITaskItem[] excludedInputPaths, CanonicalTrackedOutputFiles outputs, bool useMinimalRebuildOptimization, bool maintainCompositeRootingMarkers) { }

        public CanonicalTrackedInputFiles(Framework.ITaskItem[] tlogFiles, Framework.ITaskItem[] sourceFiles, Framework.ITaskItem[] excludedInputPaths, CanonicalTrackedOutputFiles outputs, bool useMinimalRebuildOptimization, bool maintainCompositeRootingMarkers) { }

        public CanonicalTrackedInputFiles(Framework.ITaskItem[] tlogFiles, Framework.ITaskItem[] sourceFiles, CanonicalTrackedOutputFiles outputs, bool useMinimalRebuildOptimization, bool maintainCompositeRootingMarkers) { }
        ...
        public Framework.ITaskItem[] ComputeSourcesNeedingCompilation() { throw null; }

        public Framework.ITaskItem[] ComputeSourcesNeedingCompilation(bool searchForSubRootsInCompositeRootingMarkers) { throw null; }

        public bool FileIsExcludedFromDependencyCheck(string fileName) { throw null; }

        public void RemoveDependenciesFromEntryIfMissing(Framework.ITaskItem source, Framework.ITaskItem correspondingOutput) { }

        public void RemoveDependenciesFromEntryIfMissing(Framework.ITaskItem source) { }

        public void RemoveDependenciesFromEntryIfMissing(Framework.ITaskItem[] source, Framework.ITaskItem[] correspondingOutputs) { }

        public void RemoveDependenciesFromEntryIfMissing(Framework.ITaskItem[] source) { }

        public void RemoveDependencyFromEntry(Framework.ITaskItem source, Framework.ITaskItem dependencyToRemove) { }

        public void RemoveDependencyFromEntry(Framework.ITaskItem[] sources, Framework.ITaskItem dependencyToRemove) { }

        public void RemoveEntriesForSource(Framework.ITaskItem source) { }
    ...
    {
        public CanonicalTrackedOutputFiles(Framework.ITask ownerTask, Framework.ITaskItem[] tlogFiles, bool constructOutputsFromTLogs) { }

        public CanonicalTrackedOutputFiles(Framework.ITask ownerTask, Framework.ITaskItem[] tlogFiles) { }

        public CanonicalTrackedOutputFiles(Framework.ITaskItem[] tlogFiles) { }
        ...
        public void AddComputedOutputsForSourceRoot(string sourceKey, Framework.ITaskItem[] computedOutputs) { }

        public void AddComputedOutputsForSourceRoot(string sourceKey, string[] computedOutputs) { }

        public Framework.ITaskItem[] OutputsForNonCompositeSource(params Framework.ITaskItem[] sources) { throw null; }

        public Framework.ITaskItem[] OutputsForSource(Framework.ITaskItem[] sources, bool searchForSubRootsInCompositeRootingMarkers) { throw null; }

        public Framework.ITaskItem[] OutputsForSource(params Framework.ITaskItem[] sources) { throw null; }
        ...
        public void RemoveEntriesForSource(Framework.ITaskItem source, Framework.ITaskItem correspondingOutput) { }

        public void RemoveEntriesForSource(Framework.ITaskItem source) { }

        public void RemoveEntriesForSource(Framework.ITaskItem[] source, Framework.ITaskItem[] correspondingOutputs) { }

        public void RemoveEntriesForSource(Framework.ITaskItem[] source) { }

        public bool RemoveOutputForSourceRoot(string sourceRoot, string outputPathToRemove) { throw null; }

        public string[] RemoveRootsWithSharedOutputs(Framework.ITaskItem[] sources) { throw null; }
    ...
    {
        public static string CreateRootingMarkerResponseFile(Framework.ITaskItem[] sources) { throw null; }
        ...
        public static bool ForceOutOfProcTracking(ExecutableType toolType, string dllName, string cancelEventName) { throw null; }

        public static bool ForceOutOfProcTracking(ExecutableType toolType) { throw null; }

        public static string FormatRootingMarker(Framework.ITaskItem source, Framework.ITaskItem output) { throw null; }

        public static string FormatRootingMarker(Framework.ITaskItem source) { throw null; }

        public static string FormatRootingMarker(Framework.ITaskItem[] sources, Framework.ITaskItem[] outputs) { throw null; }

        public static string FormatRootingMarker(Framework.ITaskItem[] sources) { throw null; }

        public static string GetFileTrackerPath(ExecutableType toolType, string rootPath) { throw null; }

        public static string GetFileTrackerPath(ExecutableType toolType) { throw null; }

        public static string GetTrackerPath(ExecutableType toolType, string rootPath) { throw null; }

        public static string GetTrackerPath(ExecutableType toolType) { throw null; }

        public static void ResumeTracking() { }

        public static void SetThreadCount(int threadCount) { }

        public static System.Diagnostics.Process StartProcess(string command, string arguments, ExecutableType toolType, string dllName, string intermediateDirectory, string rootFiles, string cancelEventName) { throw null; }

        public static System.Diagnostics.Process StartProcess(string command, string arguments, ExecutableType toolType, string dllName, string intermediateDirectory, string rootFiles) { throw null; }

        public static System.Diagnostics.Process StartProcess(string command, string arguments, ExecutableType toolType, string intermediateDirectory, string rootFiles) { throw null; }

        public static System.Diagnostics.Process StartProcess(string command, string arguments, ExecutableType toolType, string rootFiles) { throw null; }

        public static System.Diagnostics.Process StartProcess(string command, string arguments, ExecutableType toolType) { throw null; }
    ...
    {
        public FlatTrackingData(Framework.ITask ownerTask, Framework.ITaskItem[] tlogFiles, bool skipMissingFiles) { }

        public FlatTrackingData(Framework.ITask ownerTask, Framework.ITaskItem[] tlogFiles, System.DateTime missingFileTimeUtc) { }

        public FlatTrackingData(Framework.ITaskItem[] tlogFiles, Framework.ITaskItem[] tlogFilesToIgnore, System.DateTime missingFileTimeUtc, string[] excludedInputPaths, System.Collections.Generic.IDictionary<string, System.DateTime> sharedLastWriteTimeUtcCache, bool treatRootMarkersAsEntries) { }

        public FlatTrackingData(Framework.ITaskItem[] tlogFiles, Framework.ITaskItem[] tlogFilesToIgnore, System.DateTime missingFileTimeUtc, string[] excludedInputPaths, System.Collections.Generic.IDictionary<string, System.DateTime> sharedLastWriteTimeUtcCache) { }

        public FlatTrackingData(Framework.ITaskItem[] tlogFiles, Framework.ITaskItem[] tlogFilesToIgnore, System.DateTime missingFileTimeUtc) { }

        public FlatTrackingData(Framework.ITaskItem[] tlogFiles, bool skipMissingFiles) { }

        public FlatTrackingData(Framework.ITaskItem[] tlogFiles, System.DateTime missingFileTimeUtc) { }
        ...
        public Framework.ITaskItem[] TlogFiles { get { throw null; } set { } }
        ...
        public static void FinalizeTLogs(bool trackedOperationsSucceeded, Framework.ITaskItem[] readTLogNames, Framework.ITaskItem[] writeTLogNames, Framework.ITaskItem[] trackedFilesToRemoveFromTLogs) { }

        public System.DateTime GetLastWriteTimeUtc(string file) { throw null; }

        public static bool IsUpToDate(Task hostTask, UpToDateCheckType upToDateCheckType, Framework.ITaskItem[] readTLogNames, Framework.ITaskItem[] writeTLogNames) { throw null; }

        public static bool IsUpToDate(TaskLoggingHelper Log, UpToDateCheckType upToDateCheckType, FlatTrackingData inputs, FlatTrackingData outputs) { throw null; }
    ...
    public sealed partial class TaskItem : System.MarshalByRefObject, Framework.ITaskItem2, Framework.ITaskItem
    {
        public TaskItem() { }
