...
namespace NuGet.Frameworks
{
    ...
    {
        internal CompatibilityMappingComparer() { }
    ...
    public static partial class FrameworkConstants
    {
        ...
        public static readonly System.Version Version9;
        public static partial class CommonFrameworks
        {
            ...
            public static readonly NuGetFramework Net10_0;
            ...
            public static readonly NuGetFramework Net48;
            public static readonly NuGetFramework Net481;
    ...
    {
        internal FrameworkRangeComparer() { }
    ...
    {
        public static T? GetNearest<T>(this System.Collections.Generic.IEnumerable<T> items, NuGetFramework projectFramework) where T : class, IFrameworkSpecific { throw null; }
    ...
    {
        internal NuGetFrameworkFullComparer() { }
    ...
    {
        internal NuGetFrameworkNameComparer() { }
    ...
    {
        public static T? GetNearest<T>(System.Collections.Generic.IEnumerable<T> items, NuGetFramework framework, IFrameworkNameProvider frameworkMappings, IFrameworkCompatibilityProvider compatibilityProvider, System.Func<T, NuGetFramework> selector) where T : class { throw null; }
        public static T? GetNearest<T>(System.Collections.Generic.IEnumerable<T> items, NuGetFramework framework, IFrameworkNameProvider frameworkMappings, IFrameworkCompatibilityProvider compatibilityProvider) where T : IFrameworkSpecific { throw null; }
        public static T? GetNearest<T>(System.Collections.Generic.IEnumerable<T> items, NuGetFramework framework, System.Func<T, NuGetFramework> selector) where T : class { throw null; }
        public static T? GetNearest<T>(System.Collections.Generic.IEnumerable<T> items, NuGetFramework framework) where T : IFrameworkSpecific { throw null; }
