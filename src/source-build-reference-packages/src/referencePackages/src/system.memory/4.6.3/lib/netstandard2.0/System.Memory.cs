...
[assembly: System.Reflection.AssemblyFileVersion("4.600.325.20307")]
[assembly: System.Reflection.AssemblyInformationalVersion("4.6.3+f62ca0009b038cab4725a720f386623a969d73ad")]
...
namespace System
{
    public static partial class MemoryExtensions
    {
        ...
        public static int BinarySearch<T, TComparer>(this ReadOnlySpan<T> span, T value, TComparer comparer) where TComparer : Collections.Generic.IComparer<T> { throw null; }
        ...
        public static int BinarySearch<T, TComparer>(this Span<T> span, T value, TComparer comparer) where TComparer : Collections.Generic.IComparer<T> { throw null; }
        ...
        public static int SequenceCompareTo<T>(this ReadOnlySpan<T> span, ReadOnlySpan<T> other) where T : IComparable<T> { throw null; }
        public static int SequenceCompareTo<T>(this Span<T> span, ReadOnlySpan<T> other) where T : IComparable<T> { throw null; }
        public static bool SequenceEqual<T>(this ReadOnlySpan<T> span, ReadOnlySpan<T> other) where T : IEquatable<T> { throw null; }
        public static bool SequenceEqual<T>(this Span<T> span, ReadOnlySpan<T> other) where T : IEquatable<T> { throw null; }
...
namespace System.Buffers
{
    public static partial class BuffersExtensions
    {
        ...
        public static SequencePosition? PositionOf<T>(this in ReadOnlySequence<T> source, T value) where T : IEquatable<T> { throw null; }
...
namespace System.Runtime.InteropServices
{
    public static partial class MemoryMarshal
    {
        ...
        public static bool TryGetMemoryManager<T, TManager>(ReadOnlyMemory<T> memory, out TManager manager, out int start, out int length) where TManager : Buffers.MemoryManager<T> { throw null; }
        public static bool TryGetMemoryManager<T, TManager>(ReadOnlyMemory<T> memory, out TManager manager) where TManager : Buffers.MemoryManager<T> { throw null; }
