...
internal sealed partial class RenderModeTagHelperProducer
{
    public sealed class Factory : FactoryBase
    {
        ...
        {
            if (!compilation.TryGetTypeByMetadataName(ComponentsApi.IComponentRenderMode.FullTypeName, out var iComponentRenderModeType))
            {
            ...
            result = new RenderModeTagHelperProducer(iComponentRenderModeType);
            return true;
        }
    }
}
