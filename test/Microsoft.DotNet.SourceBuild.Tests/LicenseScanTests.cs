...
public class LicenseScanTests : TestBase
{
    ...
    private static readonly string[] s_allowedLicenseExpressions = new string[]
    {
        ...
        "bsd-2-clause-views", // https://opensource.org/license/bsd-2-clause
        ...
        "clear-bsd", // https://github.com/aboutcode-org/scancode-toolkit/blob/develop/src/licensedcode/data/licenses/clear-bsd.LICENSE
